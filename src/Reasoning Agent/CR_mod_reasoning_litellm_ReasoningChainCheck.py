                ...
                if match:
                    ...
                    response = completion(
                        ...
                        messages = [{ "content": f"""
                                    ...
                                    Evaluate whether the program and it's output are acceptable for answering the question, focusing on correctness as well as the 
                                    relevance and appropriateness given the question's context. You should evaluate each of the reasoning steps outlined in the
                                    ...
                                    Part 1 of the response should include a short explanation. Part 2 should specify "Y" if acceptable, and "N" if not acceptable.\n
